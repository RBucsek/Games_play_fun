...
public class SF_GoodGuy {
    ...
    public void loadTexture(GL10 gl, int texture,Context context){
        ...
        gl.glTexParameterf(GL10.GL_TEXTURE_2D, GL10.GL_TEXTURE_WRAP_S, GL10.GL_CLAMP_TO_EDGE);//pohyb drahy
        gl.glTexParameterf(GL10.GL_TEXTURE_2D, GL10.GL_TEXTURE_WRAP_T, GL10.GL_CLAMP_TO_EDGE);//pohyb drahy
